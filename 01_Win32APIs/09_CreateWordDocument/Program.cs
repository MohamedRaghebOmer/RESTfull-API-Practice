    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                para.Range.Text = "Hi, My Name is Mohammed Ragheb\n##I am 18 years old.";  // Your name goes here

                // Save the document
                string filepath = Path.Combine(Directory.GetCurrentDirectory(), "MyDocument.docx");  // Change the path as needed
